/**
 * @file yapp_fold.c
 * Folds dedispersed time series data at the specified period.
 *
 * @verbatim
 * Usage: yapp_dedisp [options] <time-series-data-file>
...
int main(int argc, char *argv[])
{
    ...
    int iNextOpt = 0;
    /* valid short options */
    const char* const pcOptsShort = "hf:d:s:S:p:P:b:c:t:oigv";
    /* valid long options */
